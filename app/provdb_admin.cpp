...
struct ProvdbArgs{
  ...
  ProvdbArgs(): engine("ofi+tcp"), server_instance(0), ninstances(1), nshards(1), db_type("unqlite"), db_write_dir("."), db_in_mem(false), db_base_config(""), db_margo_config(""), db_use_aggregator(false), db_batch_size(64), db_bypass_unqlite(true){}
};
