...
export EXE_NAME=(main1 main2)  #the name of the executable (without path). For multi-component workflows this argument also accepts a list, e.g. (main1 main2)  <------------ ***SET ME***
